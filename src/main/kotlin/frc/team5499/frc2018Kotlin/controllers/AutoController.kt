...
object AutoController : Controller() {
    ...
    private var boolean is_finished
    ...
    */
    ...
    right_two_cube.addAction(ParallelAction(5, Arrays.asList(
    ...
    baseline.addAction(DriveStraightAction(3, -106))
    ...
    right_outer_one_cube.addAction(DriveStraightAction(3, -150))
    right_outer_one_cube.addAction(TurnAction(2, 90))
    right_outer_one_cube.addAction(DriveStraightAction(1.5, -35))
    ...
    left_outer_one_cube.addAction(DriveStraightAction(3, -150))
    left_outer_one_cube.addAction(TurnAction(1.5, -90))
    left_outer_one_cube.addAction(DriveStraightAction(1.5, -35))
    ...
    public fun AutoController getInstance() {
        return _instance
    }
}*/